...
- Evidence added: focused annotation, observe, source, and registry-derived CLI contract checks; source/observe/annotation smoke checks; full relevant ruff checks; `compileall`; sandbox full default suite failure limited to dashboard loopback bind `PermissionError`; and elevated full default suite pass.
