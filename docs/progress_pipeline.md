...
- Evidence added: focused annotation, observe, source, removal/trash, auth/key, maintenance backup/cache, and registry-derived CLI contract checks; source/observe/annotation/removal/auth/maintenance smoke checks; full relevant ruff checks; `compileall`; sandbox full default suite failure limited to dashboard loopback bind `PermissionError`; and elevated full default suite pass.
