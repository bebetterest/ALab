...
description: Use when administering an ALab home with root authority, including home bootstrap, root and project-admin credential management, project initialization and handoff, SkyDiscover catalog management, global cache or backup pruning, and root-level audit/dashboard inspection. Do not use for routine project coordination or experiment implementation.
---
...
- This skill is not the project-coordination layer and not the experiment-implementation layer.
...
- Hand experiment implementation or worktree edits to a separate session/thread or subagent in that experiment worktree using `alab-experiment-worker`.
