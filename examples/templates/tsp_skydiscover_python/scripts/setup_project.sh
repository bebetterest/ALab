...
Initializes the SkyDiscover Python TSP template with an isolated ALab home.
EOF
      exit 0
      ;;
    *)
...
if [[ "$DRY_RUN" == "1" ]]; then
  cat <<EOF
Would initialize the SkyDiscover Python TSP template.
...
{
  printf '# Generated by examples/templates/tsp_skydiscover_python/scripts/setup_project.sh\n'
...
# TSP SkyDiscover Python Template Setup
