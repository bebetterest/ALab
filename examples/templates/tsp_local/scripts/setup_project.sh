...
Initializes the local TSP template with an isolated ALab home.
EOF
      exit 0
      ;;
    *)
...
if [[ "$DRY_RUN" == "1" ]]; then
  cat <<EOF
Would initialize the local TSP template.
...
{
  printf '# Generated by examples/templates/tsp_local/scripts/setup_project.sh\n'
