...
_COMPAT_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "SKYDISCOVER_ORIGIN_URL": (".catalog", "SKYDISCOVER_ORIGIN_URL"),
    ...
    "_recognize_skydiscover_target": (".catalog", "_recognize_skydiscover_target"),
    ...
    "cmd_annotate_add": (".annotations", "cmd_annotate_add"),
    "cmd_annotate_archive": (".annotations", "cmd_annotate_archive"),
    "cmd_annotate_edit": (".annotations", "cmd_annotate_edit"),
    "cmd_annotate_remove": (".annotations", "cmd_annotate_remove"),
    "cmd_annotate_unarchive": (".annotations", "cmd_annotate_unarchive"),
    "cmd_audit_list": (".audit", "cmd_audit_list"),
    "cmd_audit_show": (".audit", "cmd_audit_show"),
    "cmd_auth_init": (".credentials", "cmd_auth_init"),
    "cmd_auth_root_regenerate": (".credentials", "cmd_auth_root_regenerate"),
    "cmd_backup_prune": (".maintenance", "cmd_backup_prune"),
    "cmd_cache_prune": (".maintenance", "cmd_cache_prune"),
    "cmd_catalog_skydiscover_add": (".catalog", "cmd_catalog_skydiscover_add"),
    "cmd_catalog_skydiscover_remove": (".catalog", "cmd_catalog_skydiscover_remove"),
    "cmd_catalog_skydiscover_show": (".catalog", "cmd_catalog_skydiscover_show"),
    "cmd_catalog_skydiscover_update": (".catalog", "cmd_catalog_skydiscover_update"),
    "cmd_dashboard": (".dashboard", "cmd_dashboard"),
    ...
    "cmd_feedback": (".feedback", "cmd_feedback"),
    "cmd_feedback_archive": (".feedback", "cmd_feedback_archive"),
    "cmd_feedback_list": (".feedback", "cmd_feedback_list"),
    "cmd_feedback_show": (".feedback", "cmd_feedback_show"),
    "cmd_key_create": (".credentials", "cmd_key_create"),
    "cmd_key_list": (".credentials", "cmd_key_list"),
    "cmd_key_revoke": (".credentials", "cmd_key_revoke"),
    "cmd_observe_annotations_list": (".annotations", "cmd_observe_annotations_list"),
    "cmd_observe_annotations_show": (".annotations", "cmd_observe_annotations_show"),
    "cmd_observe_artifacts_archive": (".observe", "cmd_observe_artifacts_archive"),
    "cmd_observe_artifacts_export": (".observe", "cmd_observe_artifacts_export"),
    "cmd_observe_artifacts_list": (".observe", "cmd_observe_artifacts_list"),
    "cmd_observe_artifacts_remove": (".observe", "cmd_observe_artifacts_remove"),
    "cmd_observe_artifacts_show": (".observe", "cmd_observe_artifacts_show"),
    "cmd_observe_artifacts_unarchive": (".observe", "cmd_observe_artifacts_unarchive"),
    "cmd_observe_logs_archive": (".observe", "cmd_observe_logs_archive"),
    "cmd_observe_logs_export": (".observe", "cmd_observe_logs_export"),
    "cmd_observe_logs_list": (".observe", "cmd_observe_logs_list"),
    "cmd_observe_logs_remove": (".observe", "cmd_observe_logs_remove"),
    "cmd_observe_logs_show": (".observe", "cmd_observe_logs_show"),
    "cmd_observe_logs_unarchive": (".observe", "cmd_observe_logs_unarchive"),
    "cmd_observe_runs_archive": (".observe", "cmd_observe_runs_archive"),
    "cmd_observe_runs_list": (".observe", "cmd_observe_runs_list"),
    "cmd_observe_runs_remove": (".observe", "cmd_observe_runs_remove"),
    "cmd_observe_runs_show": (".observe", "cmd_observe_runs_show"),
    "cmd_observe_runs_unarchive": (".observe", "cmd_observe_runs_unarchive"),
    ...
    "cmd_report": (".report", "cmd_report"),
    "cmd_source_archive": (".sources", "cmd_source_archive"),
    "cmd_source_import": (".sources", "cmd_source_import"),
    "cmd_source_list": (".sources", "cmd_source_list"),
    "cmd_source_remove": (".sources", "cmd_source_remove"),
    "cmd_source_show": (".sources", "cmd_source_show"),
    "cmd_source_unarchive": (".sources", "cmd_source_unarchive"),
}
